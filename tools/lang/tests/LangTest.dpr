...
// Test-only catalogs generated by make_fixture_res.js: an unsigned one and
// one carrying a bogus signature. Both must be refused, which is what makes
// their absence from the report a real assertion rather than a tautology.
{$R langtest_fixture.res}
